  ...
  useEffect(() => {
    fetch('/data/cakes.json')
      ...
      .then((data) => {
        ...
        const filteredCakes = data.filter(cake => cake.category === 'poundcake');
  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Rich, buttery, and delicious. Our pound cakes are perfect for everyday indulgence 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {poundCakes.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-600">No pound cakes available at the moment.</p>
          </div>
        )}
      </div>
    </div>
