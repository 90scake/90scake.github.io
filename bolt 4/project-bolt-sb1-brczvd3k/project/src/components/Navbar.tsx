    ...
    >
      <div className="container-custom flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8">
          <a href="#" className="text-gray-700 hover:text-primary-500 font-medium">Home</a>
          <a href="#gallery" className="text-gray-700 hover:text-primary-500 font-medium">Cakes</a>
          <a href="#pound-cakes" className="text-gray-700 hover:text-primary-500 font-medium">Pound Cakes</a>
