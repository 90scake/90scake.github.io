        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-600">+880 1704159550</span>
            </div>
            <div className="flex items-center">
              <Mail size={18} className="text-pink-600 mr-2" />
              <span className="text-gray-600">90s.cake.bd@gmail.com</span>
            </div>
            <p className="text-gray-600">Puran Kochukhet, Dhaka, Bangladesh</p>
          </div>
        </div>
